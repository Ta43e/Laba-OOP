...
namespace LABA17_18
{
    internal class TestProgram
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine("===============Adapter=========LABA 19-20==================================="); // адаптер
            CheL cheL = new CheL(administrator);
            cheL.Pokupka(client1);
            IShopping shopping = new AdministratorToShopAdapter(administrator);
            cheL.Pokupka(shopping);
            Console.WriteLine("===================Decorator=====0000==================================="); // декодатор
            BaseProduct baseProduct = new Product("4eto", Cost);
            baseProduct = new ColProduct(baseProduct, administrator);
            administrator.PrintListProduct();
            Console.WriteLine("====================Observer=====0000==================================="); //наблюдатель
            Client client5 = new Client("Nikita", 321, onlineStore, administrator);
            administrator.AddProduct("Nout", Cost5);
            Console.WriteLine("===============Memento=====0000===================================");// хранитель
            Backup backup = new Backup();
            backup.History.Push(onlineStore.Save());
            Client client11 = new Client("Anton1", 2131, onlineStore);
            Client client12 = new Client("Anton2", 2132, onlineStore);
            Client client13 = new Client("Anton3", 2133, onlineStore);
            onlineStore.RestoreState(backup.History.Pop());
            Console.WriteLine("================Templete Methpd========0000==================================="); // Шаблонный
            administrator.Shopping(administrator.GetList());
            client5.Shopping(administrator.GetList());
