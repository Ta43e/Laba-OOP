...
namespace LABA17_18
{
    public class Client : Template_Method, IShopping, IObserver
    {
        private string name;
        public int Id;
        ...
        public Client(string name, int id, OnlineStore onlineStore, IObservable obs)
        {
            this.name = name;
            Id = id;
            ListShopping = new List<Product>();
        ...
        public void Update(object obj)
        {
            ...
            {
                if(item.GetCost() < 1500)
                {
                    Console.WriteLine($"Отличная цена на {item.Name}, стоит брать!");
                }
                else
                {
                    Console.WriteLine("Хм, может стоит подождать распродажу?");
                }
            }
        }
        ...
        {
            Console.WriteLine("Покупатель уходит довольный!");
        }
